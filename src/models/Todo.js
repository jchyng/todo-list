...
// 인덱스 생성 (복합 인덱스)
TodoSchema.index({ userId: 1, isDeleted: 1, createdAt: -1 }); // 사용자별 활성 할 일 최신순 조회
TodoSchema.index({ userId: 1, isDeleted: 1, completed: 1 }); // 사용자별 활성 할 일 완료 상태 조회
TodoSchema.index({ userId: 1, isDeleted: 1, dueDate: 1 }); // 사용자별 활성 할 일 마감일 조회
...
// 정적 메서드: 사용자별 할 일 조회 (삭제되지 않은 항목만)
...
// 정적 메서드: 날짜 범위별 할 일 조회 (삭제되지 않은 항목만)
...
// 정적 메서드: 사용자의 모든 할 일을 논리적 삭제
TodoSchema.statics.softDeleteAllByUserId = function (userId) {
